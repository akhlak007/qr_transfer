...
export function transitionSession(session: TransferSession, status: TransferStatus, now = Date.now()): TransferSession {
...
export function setResumeCapability(session: TransferSession, resumeCapability: ResumeCapability, now = Date.now()): TransferSession {
